window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".KNlpga_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.KNlpga_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.KNlpga_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.KNlpga_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.KNlpga_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.KNlpga_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.KNlpga_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.KNlpga_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.KNlpga_tab.KNlpga_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.KNlpga_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.KNlpga_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.KNlpga_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.KNlpga_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.KNlpga_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.KNlpga_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.KNlpga_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.KNlpga_cats{margin:0 -4px 2px;padding:12px 4px 4px}.KNlpga_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.KNlpga_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.KNlpga_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.KNlpga_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.KNlpga_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.KNlpga_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.KNlpga_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.KNlpga_catsCollapsed{max-height:62px;overflow:hidden}.KNlpga_catsToggle.KNlpga_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.KNlpga_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.KNlpga_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.KNlpga_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.KNlpga_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.KNlpga_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.KNlpga_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.KNlpga_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.KNlpga_lightboxClose:hover{background:#ffffff38}.KNlpga_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.KNlpga_lightboxNav:hover{background:#ffffff38}.KNlpga_lightboxPrev{left:16px}.KNlpga_lightboxNext{right:16px}.KNlpga_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.KNlpga_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.KNlpga_lightboxDotOn{background:#fff}.KNlpga_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.KNlpga_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.KNlpga_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.KNlpga_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.KNlpga_masonry{align-items:flex-start;gap:10px;display:flex}.KNlpga_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.KNlpga_masonry>.KNlpga_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.KNlpga_masonry{flex-direction:column}.KNlpga_masonryCol{width:100%}.KNlpga_grid{grid-template-columns:minmax(0,1fr)}}.KNlpga_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.KNlpga_themesGrid{margin-bottom:12px}.KNlpga_swatches i{flex:1}.KNlpga_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.KNlpga_themeSearch{box-sizing:border-box;width:100%;min-width:0}.KNlpga_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.KNlpga_themeFullscreenBtn.KNlpga_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.KNlpga_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.KNlpga_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.KNlpga_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.KNlpga_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.KNlpga_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.KNlpga_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.KNlpga_themeCover:hover img{transform:scale(1.012)}.KNlpga_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.KNlpga_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.KNlpga_themePreviewAction,.KNlpga_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.KNlpga_themePreviewAction{gap:4px;right:8px}.KNlpga_themePreviewCount{left:8px}.KNlpga_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.KNlpga_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.KNlpga_themeIdentity{flex:1;min-width:0}.KNlpga_themeStatus,.KNlpga_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.KNlpga_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.KNlpga_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.KNlpga_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.KNlpga_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.KNlpga_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.KNlpga_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.KNlpga_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.KNlpga_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.KNlpga_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.KNlpga_sub>span:first-child{grid-area:1/1}.KNlpga_sub>.KNlpga_grow{display:none}.KNlpga_submitLink{grid-area:2/1}.KNlpga_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.KNlpga_themeToolbar{grid-template-columns:minmax(0,1fr)}.KNlpga_themeCardHead{flex-wrap:wrap}.KNlpga_themeStatus,.KNlpga_themeStatusMuted{order:3}}@container (width<=280px){.KNlpga_themeCardFooter{flex-direction:column;align-items:flex-start}.KNlpga_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.KNlpga_themeCard,.KNlpga_themeCover img{transition:none}.KNlpga_themeCard:hover{transform:none}}.KNlpga_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.KNlpga_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.KNlpga_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.KNlpga_installBtn.KNlpga_installBtn{min-width:64px}.KNlpga_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.KNlpga_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.KNlpga_nmLink{color:inherit;text-decoration:none;display:block}.KNlpga_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.KNlpga_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.KNlpga_nmLink:hover .KNlpga_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.KNlpga_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.KNlpga_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.KNlpga_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.KNlpga_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.KNlpga_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.KNlpga_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.KNlpga_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.KNlpga_foot .KNlpga_metaInline,.KNlpga_foot .KNlpga_src{white-space:nowrap}.KNlpga_grow{flex:1}.KNlpga_titleRow{align-items:center;gap:10px;display:flex}.KNlpga_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.KNlpga_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.KNlpga_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.KNlpga_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.KNlpga_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.KNlpga_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.KNlpga_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.KNlpga_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.KNlpga_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.KNlpga_noteInput{flex:1;min-width:160px}.KNlpga_descTight{min-height:0}.KNlpga_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.KNlpga_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_dot{vertical-align:2px;margin-left:5px}.KNlpga_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.KNlpga_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.KNlpga_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.KNlpga_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.KNlpga_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.KNlpga_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.KNlpga_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite KNlpga_sp;display:inline-flex}.KNlpga_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.KNlpga_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite KNlpga_dshmPlug}@keyframes KNlpga_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.KNlpga_logoPlug,.KNlpga_spin{animation:1.5s ease-in-out infinite KNlpga_dshmPlugFade}}@keyframes KNlpga_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes KNlpga_sp{to{transform:rotate(360deg)}}.KNlpga_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.KNlpga_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.KNlpga_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.KNlpga_barWave{width:30%;animation:1.2s ease-in-out infinite KNlpga_dshmSlide}@keyframes KNlpga_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.KNlpga_irow .KNlpga_progress{margin-top:8px}.KNlpga_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.KNlpga_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.KNlpga_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.KNlpga_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.KNlpga_conflictHead{align-items:flex-start;gap:8px;display:flex}.KNlpga_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.KNlpga_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.KNlpga_conflictBody{margin:0;font-size:12px;line-height:19px}.KNlpga_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.KNlpga_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.KNlpga_rosterMain{flex-direction:column;min-width:0;display:flex}.KNlpga_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.KNlpga_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.KNlpga_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.KNlpga_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.KNlpga_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.KNlpga_rosterRowOut .KNlpga_rosterName{text-decoration:line-through}.KNlpga_rosterRowOut{opacity:.62}.KNlpga_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.KNlpga_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.KNlpga_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.KNlpga_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.KNlpga_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.KNlpga_choices{flex-direction:column;gap:7px;display:flex}.KNlpga_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.KNlpga_choice:has(input:disabled){cursor:default;opacity:.6}.KNlpga_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.KNlpga_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.KNlpga_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.KNlpga_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.KNlpga_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.KNlpga_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.KNlpga_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.KNlpga_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.KNlpga_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.KNlpga_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.KNlpga_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.KNlpga_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.KNlpga_nameLink{color:inherit;text-decoration:none}.KNlpga_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.KNlpga_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.KNlpga_irowName>.KNlpga_owner{flex:none}.KNlpga_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.KNlpga_opWrap{flex-shrink:0;display:inline-flex;position:relative}.KNlpga_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.KNlpga_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.KNlpga_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.KNlpga_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.KNlpga_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.KNlpga_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.KNlpga_opPanelTitle{font-size:12.5px;font-weight:600}.KNlpga_opCloseBtn.KNlpga_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.KNlpga_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.KNlpga_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.KNlpga_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.KNlpga_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.KNlpga_opRow:last-child{border-bottom:none}.KNlpga_opRowAlert{background:#dc26260f}.KNlpga_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.KNlpga_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.KNlpga_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.KNlpga_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.KNlpga_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.KNlpga_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.KNlpga_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.KNlpga_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.KNlpga_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.KNlpga_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.KNlpga_opDecisionFoot{align-items:center;gap:8px;display:flex}.KNlpga_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.KNlpga_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.KNlpga_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.KNlpga_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.KNlpga_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.KNlpga_dangerBtn.KNlpga_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.KNlpga_dangerBtn.KNlpga_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.KNlpga_dangerArmed.KNlpga_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.KNlpga_retryBtn{margin-top:4px}.KNlpga_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.KNlpga_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.KNlpga_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.KNlpga_irowMissing{filter:grayscale();opacity:.5}.KNlpga_irow>.KNlpga_src,.KNlpga_irow>.KNlpga_owner,.KNlpga_irow button{white-space:nowrap;flex-shrink:0}.KNlpga_tabSearchRow{padding:0 4px 6px;display:flex}.KNlpga_tabSearch{width:100%}.KNlpga_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.KNlpga_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.KNlpga_specTagGit{color:#0b7285;background:#12a3c41f}.KNlpga_specTagFile{color:#b07d1b;background:#f0b42924}.KNlpga_backupCheckList .KNlpga_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.KNlpga_backupCheckList .KNlpga_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.KNlpga_staleAction{margin-top:8px}.KNlpga_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.KNlpga_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.KNlpga_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.KNlpga_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.KNlpga_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.KNlpga_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.KNlpga_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.KNlpga_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.KNlpga_deprecate .KNlpga_src{margin-left:8px}.KNlpga_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.KNlpga_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.KNlpga_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.KNlpga_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.KNlpga_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.KNlpga_switchOn .KNlpga_switchKnob,.KNlpga_switchMixed .KNlpga_switchKnob{left:18px}.KNlpga_switch:disabled{opacity:.5;cursor:default}.KNlpga_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.KNlpga_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.KNlpga_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.KNlpga_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.KNlpga_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.KNlpga_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.KNlpga_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.KNlpga_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.KNlpga_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.KNlpga_groupMember .KNlpga_nm{flex:1;min-width:0;font-size:12px}.KNlpga_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.KNlpga_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.KNlpga_inlineInput{flex:1;min-width:120px}.KNlpga_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.KNlpga_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.KNlpga_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.KNlpga_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.KNlpga_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.KNlpga_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.KNlpga_backupCard h3{margin:0;font-size:14px}.KNlpga_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.KNlpga_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.KNlpga_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.KNlpga_backupInput{box-sizing:border-box;width:100%}.KNlpga_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.KNlpga_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.KNlpga_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.KNlpga_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.KNlpga_backupCheckList .KNlpga_backupCheck{justify-content:space-between;gap:8px}.KNlpga_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.KNlpga_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.KNlpga_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.KNlpga_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.KNlpga_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.KNlpga_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.KNlpga_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.KNlpga_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.KNlpga_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.KNlpga_diagBundle:first-of-type{border-top:none;padding-top:0}.KNlpga_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.KNlpga_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.KNlpga_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.KNlpga_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.KNlpga_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.KNlpga_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.KNlpga_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.KNlpga_diagList{flex-direction:column;gap:6px;display:flex}.KNlpga_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.KNlpga_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.KNlpga_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.KNlpga_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.KNlpga_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.KNlpga_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.KNlpga_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.KNlpga_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.KNlpga_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.KNlpga_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.KNlpga_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.KNlpga_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.KNlpga_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.KNlpga_collapseTitle{flex:1;min-width:0}.KNlpga_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.KNlpga_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.KNlpga_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.KNlpga_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.KNlpga_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.KNlpga_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.KNlpga_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.KNlpga_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.KNlpga_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.KNlpga_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.KNlpga_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.KNlpga_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.KNlpga_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.KNlpga_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.KNlpga_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.KNlpga_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.KNlpga_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.KNlpga_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.KNlpga_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.KNlpga_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.KNlpga_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.KNlpga_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.KNlpga_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.KNlpga_setChevronOpen{transform:rotate(180deg)}.KNlpga_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.KNlpga_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.KNlpga_setRow+.KNlpga_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.KNlpga_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.KNlpga_setLabel{font-size:13px;line-height:20px}.KNlpga_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.KNlpga_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.KNlpga_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.KNlpga_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.KNlpga_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.KNlpga_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.KNlpga_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.KNlpga_setSegBtn:disabled{cursor:default;opacity:.5}.KNlpga_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.KNlpga_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.KNlpga_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.KNlpga_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.KNlpga_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.KNlpga_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.KNlpga_commentsStatus:empty{display:none}.KNlpga_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.KNlpga_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.KNlpga_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.KNlpga_commentsMount iframe{width:100%}.KNlpga_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.KNlpga_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.KNlpga_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.KNlpga_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.KNlpga_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.KNlpga_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.KNlpga_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.KNlpga_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.KNlpga_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.KNlpga_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.KNlpga_notesP{font-size:13px;line-height:20px}.KNlpga_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.KNlpga_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.KNlpga_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.KNlpga_notesRow:last-child{border-bottom:none}.KNlpga_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.KNlpga_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.KNlpga_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.KNlpga_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.KNlpga_notesVer{color:inherit;font-weight:600;text-decoration:none}.KNlpga_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "KNlpga_act",
			"actBroken": "KNlpga_actBroken",
			"actLive": "KNlpga_actLive",
			"actWarn": "KNlpga_actWarn",
			"actWhy": "KNlpga_actWhy",
			"assignRow": "KNlpga_assignRow",
			"assignSelect": "KNlpga_assignSelect",
			"av": "KNlpga_av",
			"backupActions": "KNlpga_backupActions",
			"backupCard": "KNlpga_backupCard",
			"backupCheck": "KNlpga_backupCheck",
			"backupCheckList": "KNlpga_backupCheckList",
			"backupGrid": "KNlpga_backupGrid",
			"backupInput": "KNlpga_backupInput",
			"backupMessage": "KNlpga_backupMessage",
			"backupWarn": "KNlpga_backupWarn",
			"banner": "KNlpga_banner",
			"bannerHint": "KNlpga_bannerHint",
			"bannerIcon": "KNlpga_bannerIcon",
			"bar": "KNlpga_bar",
			"barFill": "KNlpga_barFill",
			"barWave": "KNlpga_barWave",
			"body": "KNlpga_body",
			"byline": "KNlpga_byline",
			"card": "KNlpga_card",
			"cardAction": "KNlpga_cardAction",
			"cardBlocked": "KNlpga_cardBlocked",
			"cardBlockedMark": "KNlpga_cardBlockedMark",
			"cardShot": "KNlpga_cardShot",
			"cardShots": "KNlpga_cardShots",
			"cats": "KNlpga_cats",
			"catsCollapsed": "KNlpga_catsCollapsed",
			"catsRow": "KNlpga_catsRow",
			"catsToggle": "KNlpga_catsToggle",
			"catsWrap": "KNlpga_catsWrap",
			"choice": "KNlpga_choice",
			"choiceMain": "KNlpga_choiceMain",
			"choiceNote": "KNlpga_choiceNote",
			"choiceOn": "KNlpga_choiceOn",
			"choiceRadio": "KNlpga_choiceRadio",
			"choices": "KNlpga_choices",
			"choiceSafe": "KNlpga_choiceSafe",
			"choiceTitle": "KNlpga_choiceTitle",
			"cmd": "KNlpga_cmd",
			"collapseBody": "KNlpga_collapseBody",
			"collapseHead": "KNlpga_collapseHead",
			"collapseIcon": "KNlpga_collapseIcon",
			"collapseTitle": "KNlpga_collapseTitle",
			"commentsError": "KNlpga_commentsError",
			"commentsFail": "KNlpga_commentsFail",
			"commentsLink": "KNlpga_commentsLink",
			"commentsMount": "KNlpga_commentsMount",
			"commentsNote": "KNlpga_commentsNote",
			"commentsStatus": "KNlpga_commentsStatus",
			"confirmRow": "KNlpga_confirmRow",
			"conflictBody": "KNlpga_conflictBody",
			"conflictDetailsToggle": "KNlpga_conflictDetailsToggle",
			"conflictHead": "KNlpga_conflictHead",
			"conflictIcon": "KNlpga_conflictIcon",
			"conflictTitle": "KNlpga_conflictTitle",
			"conflictWhy": "KNlpga_conflictWhy",
			"conflictWhyText": "KNlpga_conflictWhyText",
			"dangerArmed": "KNlpga_dangerArmed",
			"dangerBtn": "KNlpga_dangerBtn",
			"depBadge": "KNlpga_depBadge",
			"depLine": "KNlpga_depLine",
			"deprecate": "KNlpga_deprecate",
			"desc": "KNlpga_desc",
			"descClamp": "KNlpga_descClamp",
			"descTight": "KNlpga_descTight",
			"descToggle": "KNlpga_descToggle",
			"diagAlert": "KNlpga_diagAlert",
			"diagArrow": "KNlpga_diagArrow",
			"diagBadgeCommunity": "KNlpga_diagBadgeCommunity",
			"diagBadgeInfo": "KNlpga_diagBadgeInfo",
			"diagBadgeOfficial": "KNlpga_diagBadgeOfficial",
			"diagBadgeShadow": "KNlpga_diagBadgeShadow",
			"diagBadgeWarn": "KNlpga_diagBadgeWarn",
			"diagBundle": "KNlpga_diagBundle",
			"diagCount": "KNlpga_diagCount",
			"diagEmpty": "KNlpga_diagEmpty",
			"diagIndex": "KNlpga_diagIndex",
			"diagKey": "KNlpga_diagKey",
			"diagList": "KNlpga_diagList",
			"diagMeta": "KNlpga_diagMeta",
			"diagPage": "KNlpga_diagPage",
			"diagRow": "KNlpga_diagRow",
			"diagSection": "KNlpga_diagSection",
			"diagSummary": "KNlpga_diagSummary",
			"diagSummaryItem": "KNlpga_diagSummaryItem",
			"diagSummaryMeta": "KNlpga_diagSummaryMeta",
			"diagVal": "KNlpga_diagVal",
			"dot": "KNlpga_dot",
			"dragging": "KNlpga_dragging",
			"dragHandle": "KNlpga_dragHandle",
			"dragOver": "KNlpga_dragOver",
			"dshmPlug": "KNlpga_dshmPlug",
			"dshmPlugFade": "KNlpga_dshmPlugFade",
			"dshmSlide": "KNlpga_dshmSlide",
			"empty": "KNlpga_empty",
			"err": "KNlpga_err",
			"exportLogBtn": "KNlpga_exportLogBtn",
			"fixFallback": "KNlpga_fixFallback",
			"fixFallbackText": "KNlpga_fixFallbackText",
			"foot": "KNlpga_foot",
			"grid": "KNlpga_grid",
			"groupActions": "KNlpga_groupActions",
			"groupAddPanel": "KNlpga_groupAddPanel",
			"groupCreate": "KNlpga_groupCreate",
			"groupHead": "KNlpga_groupHead",
			"groupHint": "KNlpga_groupHint",
			"groupMember": "KNlpga_groupMember",
			"groupMembers": "KNlpga_groupMembers",
			"groupName": "KNlpga_groupName",
			"groupRow": "KNlpga_groupRow",
			"grow": "KNlpga_grow",
			"head": "KNlpga_head",
			"hiddenFile": "KNlpga_hiddenFile",
			"inlineInput": "KNlpga_inlineInput",
			"installBtn": "KNlpga_installBtn",
			"irow": "KNlpga_irow",
			"irowActions": "KNlpga_irowActions",
			"irowMissing": "KNlpga_irowMissing",
			"irowName": "KNlpga_irowName",
			"irowNameText": "KNlpga_irowNameText",
			"irowTrailing": "KNlpga_irowTrailing",
			"lightbox": "KNlpga_lightbox",
			"lightboxClose": "KNlpga_lightboxClose",
			"lightboxDot": "KNlpga_lightboxDot",
			"lightboxDotOn": "KNlpga_lightboxDotOn",
			"lightboxDots": "KNlpga_lightboxDots",
			"lightboxImg": "KNlpga_lightboxImg",
			"lightboxNav": "KNlpga_lightboxNav",
			"lightboxNext": "KNlpga_lightboxNext",
			"lightboxPrev": "KNlpga_lightboxPrev",
			"loading": "KNlpga_loading",
			"logoMark": "KNlpga_logoMark",
			"logoPlug": "KNlpga_logoPlug",
			"masonry": "KNlpga_masonry",
			"masonryCol": "KNlpga_masonryCol",
			"meta": "KNlpga_meta",
			"metaInline": "KNlpga_metaInline",
			"metaTag": "KNlpga_metaTag",
			"metaTagOk": "KNlpga_metaTagOk",
			"modalNote": "KNlpga_modalNote",
			"nameLink": "KNlpga_nameLink",
			"nm": "KNlpga_nm",
			"nmLink": "KNlpga_nmLink",
			"noteAction": "KNlpga_noteAction",
			"noteEdit": "KNlpga_noteEdit",
			"noteInput": "KNlpga_noteInput",
			"noteMine": "KNlpga_noteMine",
			"noteRow": "KNlpga_noteRow",
			"notesArrow": "KNlpga_notesArrow",
			"notesBody": "KNlpga_notesBody",
			"notesCode": "KNlpga_notesCode",
			"notesDate": "KNlpga_notesDate",
			"notesH": "KNlpga_notesH",
			"notesLink": "KNlpga_notesLink",
			"notesList": "KNlpga_notesList",
			"notesMeta": "KNlpga_notesMeta",
			"notesMsg": "KNlpga_notesMsg",
			"notesP": "KNlpga_notesP",
			"notesPre": "KNlpga_notesPre",
			"notesRange": "KNlpga_notesRange",
			"notesRendered": "KNlpga_notesRendered",
			"notesRow": "KNlpga_notesRow",
			"notesSha": "KNlpga_notesSha",
			"notesVer": "KNlpga_notesVer",
			"noteToggle": "KNlpga_noteToggle",
			"okState": "KNlpga_okState",
			"on": "KNlpga_on",
			"opActions": "KNlpga_opActions",
			"opAggregate": "KNlpga_opAggregate",
			"opAggregateHint": "KNlpga_opAggregateHint",
			"opAggregateTop": "KNlpga_opAggregateTop",
			"opCloseBtn": "KNlpga_opCloseBtn",
			"opDecision": "KNlpga_opDecision",
			"opDecisionFoot": "KNlpga_opDecisionFoot",
			"opDot": "KNlpga_opDot",
			"opEmpty": "KNlpga_opEmpty",
			"opEmptyHint": "KNlpga_opEmptyHint",
			"opEntry": "KNlpga_opEntry",
			"opEntryAlert": "KNlpga_opEntryAlert",
			"opEntryQuiet": "KNlpga_opEntryQuiet",
			"opHead": "KNlpga_opHead",
			"opIcon": "KNlpga_opIcon",
			"opMain": "KNlpga_opMain",
			"opName": "KNlpga_opName",
			"opPanel": "KNlpga_opPanel",
			"opPanelTitle": "KNlpga_opPanelTitle",
			"opQueuedIcon": "KNlpga_opQueuedIcon",
			"opRow": "KNlpga_opRow",
			"opRowAlert": "KNlpga_opRowAlert",
			"opStatus": "KNlpga_opStatus",
			"opStatusBad": "KNlpga_opStatusBad",
			"opTop": "KNlpga_opTop",
			"opVerb": "KNlpga_opVerb",
			"opWrap": "KNlpga_opWrap",
			"orderPanel": "KNlpga_orderPanel",
			"orphBadge": "KNlpga_orphBadge",
			"orphRow": "KNlpga_orphRow",
			"ovArrow": "KNlpga_ovArrow",
			"ovByTag": "KNlpga_ovByTag",
			"ovFrom": "KNlpga_ovFrom",
			"ovRow": "KNlpga_ovRow",
			"owner": "KNlpga_owner",
			"pageEllipsis": "KNlpga_pageEllipsis",
			"pageInfo": "KNlpga_pageInfo",
			"pager": "KNlpga_pager",
			"pagerPages": "KNlpga_pagerPages",
			"panelActions": "KNlpga_panelActions",
			"panelNote": "KNlpga_panelNote",
			"pct": "KNlpga_pct",
			"presetList": "KNlpga_presetList",
			"presetName": "KNlpga_presetName",
			"presetRow": "KNlpga_presetRow",
			"progress": "KNlpga_progress",
			"reassure": "KNlpga_reassure",
			"reassureOk": "KNlpga_reassureOk",
			"repoLink": "KNlpga_repoLink",
			"repoMark": "KNlpga_repoMark",
			"retryBtn": "KNlpga_retryBtn",
			"root": "KNlpga_root",
			"roster": "KNlpga_roster",
			"rosterAuthor": "KNlpga_rosterAuthor",
			"rosterMain": "KNlpga_rosterMain",
			"rosterName": "KNlpga_rosterName",
			"rosterRow": "KNlpga_rosterRow",
			"rosterRowOut": "KNlpga_rosterRowOut",
			"rosterSplit": "KNlpga_rosterSplit",
			"rosterTag": "KNlpga_rosterTag",
			"rosterTagDrop": "KNlpga_rosterTagDrop",
			"rosterTagKeep": "KNlpga_rosterTagKeep",
			"row1": "KNlpga_row1",
			"sectAction": "KNlpga_sectAction",
			"sectionOverview": "KNlpga_sectionOverview",
			"setActions": "KNlpga_setActions",
			"setBetaTag": "KNlpga_setBetaTag",
			"setBody": "KNlpga_setBody",
			"setCard": "KNlpga_setCard",
			"setCardOpen": "KNlpga_setCardOpen",
			"setCheck": "KNlpga_setCheck",
			"setChevron": "KNlpga_setChevron",
			"setChevronOpen": "KNlpga_setChevronOpen",
			"setConfirm": "KNlpga_setConfirm",
			"setDanger": "KNlpga_setDanger",
			"setDesc": "KNlpga_setDesc",
			"setHeader": "KNlpga_setHeader",
			"setHeadText": "KNlpga_setHeadText",
			"setHint": "KNlpga_setHint",
			"setLabel": "KNlpga_setLabel",
			"setLabelBox": "KNlpga_setLabelBox",
			"setName": "KNlpga_setName",
			"setRow": "KNlpga_setRow",
			"setSeg": "KNlpga_setSeg",
			"setSegBtn": "KNlpga_setSegBtn",
			"setSegOn": "KNlpga_setSegOn",
			"shot": "KNlpga_shot",
			"shots": "KNlpga_shots",
			"snapConfirmText": "KNlpga_snapConfirmText",
			"snapList": "KNlpga_snapList",
			"snapMeta": "KNlpga_snapMeta",
			"snapRow": "KNlpga_snapRow",
			"sp": "KNlpga_sp",
			"spec": "KNlpga_spec",
			"specTag": "KNlpga_specTag",
			"specTagFile": "KNlpga_specTagFile",
			"specTagGit": "KNlpga_specTagGit",
			"spin": "KNlpga_spin",
			"src": "KNlpga_src",
			"staleAction": "KNlpga_staleAction",
			"star": "KNlpga_star",
			"stateDot": "KNlpga_stateDot",
			"stateTag": "KNlpga_stateTag",
			"stickyHead": "KNlpga_stickyHead",
			"sub": "KNlpga_sub",
			"submitLink": "KNlpga_submitLink",
			"subTabs": "KNlpga_subTabs",
			"swatches": "KNlpga_swatches",
			"switch": "KNlpga_switch",
			"switchKnob": "KNlpga_switchKnob",
			"switchMixed": "KNlpga_switchMixed",
			"switchOn": "KNlpga_switchOn",
			"tab": "KNlpga_tab",
			"tabs": "KNlpga_tabs",
			"tabSearch": "KNlpga_tabSearch",
			"tabSearchRow": "KNlpga_tabSearchRow",
			"tag": "KNlpga_tag",
			"themeActions": "KNlpga_themeActions",
			"themeCard": "KNlpga_themeCard",
			"themeCardBody": "KNlpga_themeCardBody",
			"themeCardFooter": "KNlpga_themeCardFooter",
			"themeCardHead": "KNlpga_themeCardHead",
			"themeCover": "KNlpga_themeCover",
			"themeCoverEmpty": "KNlpga_themeCoverEmpty",
			"themeDescription": "KNlpga_themeDescription",
			"themeFullscreenBtn": "KNlpga_themeFullscreenBtn",
			"themeGallery": "KNlpga_themeGallery",
			"themeIdentity": "KNlpga_themeIdentity",
			"themeLifecycle": "KNlpga_themeLifecycle",
			"themePreviewAction": "KNlpga_themePreviewAction",
			"themePreviewCount": "KNlpga_themePreviewCount",
			"themeResultBar": "KNlpga_themeResultBar",
			"themeSearch": "KNlpga_themeSearch",
			"themesGrid": "KNlpga_themesGrid",
			"themeStatus": "KNlpga_themeStatus",
			"themeStatusMuted": "KNlpga_themeStatusMuted",
			"themeToolbar": "KNlpga_themeToolbar",
			"themeToolbarActions": "KNlpga_themeToolbarActions",
			"title": "KNlpga_title",
			"titleRow": "KNlpga_titleRow",
			"top": "KNlpga_top",
			"topBtn": "KNlpga_topBtn",
			"version": "KNlpga_version",
			"viewBar": "KNlpga_viewBar",
			"viewBtn": "KNlpga_viewBtn",
			"viewOn": "KNlpga_viewOn",
			"warnLine": "KNlpga_warnLine"
		};
		//#endregion
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)(ThemeCover, {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [instName === null && /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											...
											children: [
												...
												notingName === name ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
													...
													if (shown === "" && note === void 0) return null;
													return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
