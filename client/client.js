window.__ModuleLoader__.load({ id: "dshmarket", factory: (require) => {
		...
		*/
		...
		const css = ".INML2G_root{min-width:0;height:100%;color:var(--dsw-alias-label-primary,#1f2328);flex-direction:column;display:flex;position:relative;container-type:inline-size}.INML2G_head{flex-direction:column;gap:12px;padding:4px 4px 6px;display:flex}.INML2G_title{margin:0;font-size:16px;font-weight:500;line-height:24px}.INML2G_sub{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:8px;margin:0;font-size:12px;line-height:18px;display:flex}.INML2G_submitLink{color:var(--dsw-alias-label-tertiary,#8b93a1);white-space:nowrap;font-size:11px;line-height:18px;text-decoration:none}.INML2G_submitLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.INML2G_tabs{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-end;gap:2px;display:flex}.INML2G_tab{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-bottom:2px solid #0000;padding:7px 12px;font-size:13px}.INML2G_tab.INML2G_on{color:var(--dsw-alias-brand-primary,#4f6ef7);border-bottom-color:var(--dsw-alias-brand-primary,#4f6ef7);font-weight:600}.INML2G_subTabs{align-items:flex-end;gap:2px;margin:-4px 0 4px;display:flex}.INML2G_banner{background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;align-items:center;gap:8px;margin:0;padding:8px 12px;font-size:12px;display:flex}.INML2G_bannerIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0}.INML2G_bannerHint{color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:help;display:inline-flex}.INML2G_body{overflow-anchor:none;flex:1;padding:12px 4px 24px;overflow-x:hidden;overflow-y:auto}.INML2G_stickyHead{z-index:5;background:var(--dsw-alias-bg-layer-2,#f7f8fa);position:sticky;top:-1px}.INML2G_stickyHead:before{content:\"\";background:inherit;pointer-events:none;height:14px;position:absolute;bottom:100%;left:0;right:0}.INML2G_cats{margin:0 -4px 2px;padding:12px 4px 4px}.INML2G_catsRow{align-items:flex-start;gap:8px;display:flex;position:relative}.INML2G_star{color:var(--dsw-alias-label-secondary,#9ca3af);white-space:nowrap;flex:none;font-size:11px}.INML2G_top{z-index:20;display:inline-flex;position:absolute;bottom:18px;right:18px}.INML2G_topBtn{border-radius:99px;width:38px;height:38px;padding:0}.INML2G_tag{border:1px solid var(--dsw-alias-border-l3,#d9dde3);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:4px;flex-shrink:0;padding:1px 6px;font-size:11px;line-height:16px}.INML2G_okState{color:var(--dsw-alias-state-success-primary,#16a34a);white-space:nowrap;font-size:12px;font-weight:600}.INML2G_catsWrap{flex-wrap:wrap;flex:1;align-items:center;gap:6px;min-width:0;display:flex}.INML2G_catsCollapsed{max-height:62px;overflow:hidden}.INML2G_catsToggle.INML2G_catsToggle{height:26px;min-height:26px;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.INML2G_shots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:8px;margin:6px 0 8px;padding:2px 0 6px;display:flex;overflow-x:auto}.INML2G_shot{object-fit:cover;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:220px;height:150px}.INML2G_cardShots{-webkit-overflow-scrolling:touch;scrollbar-width:thin;gap:6px;margin:0 0 6px;padding:0 0 2px;display:flex;overflow-x:auto}.INML2G_cardShot{object-fit:contain;border:1px solid var(--dsw-alias-border-default,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);cursor:pointer;border-radius:8px;flex:none;width:132px;height:88px;display:block}.INML2G_lightbox{z-index:10000;cursor:zoom-out;background:#000000d9;justify-content:center;align-items:center;display:flex;position:fixed;top:0;bottom:0;left:0;right:0}.INML2G_lightboxImg{object-fit:contain;cursor:default;border-radius:4px;max-width:90vw;max-height:85vh}.INML2G_lightboxClose{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:36px;height:36px;font-size:22px;line-height:1;display:grid;position:absolute;top:16px;right:16px}.INML2G_lightboxClose:hover{background:#ffffff38}.INML2G_lightboxNav{color:#fff;cursor:pointer;background:#ffffff1f;border:none;border-radius:99px;place-items:center;width:44px;height:44px;display:grid;position:absolute;top:50%;transform:translateY(-50%)}.INML2G_lightboxNav:hover{background:#ffffff38}.INML2G_lightboxPrev{left:16px}.INML2G_lightboxNext{right:16px}.INML2G_lightboxDots{gap:8px;display:flex;position:absolute;bottom:20px;left:50%;transform:translate(-50%)}.INML2G_lightboxDot{cursor:pointer;background:#fff6;border-radius:99px;width:7px;height:7px}.INML2G_lightboxDotOn{background:#fff}.INML2G_cmd{background:var(--dsw-alias-bg-layer-2,#f3f4f6);word-break:break-all;border-radius:6px;margin:8px 0 0;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:18px}.INML2G_warnLine{color:var(--dsw-alias-state-warn-primary,#b45309);flex-wrap:wrap;align-items:center;gap:4px;margin:0;font-size:12px;font-weight:600;line-height:18px;display:flex}.INML2G_modalNote{color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;gap:4px;margin:12px 0 0;font-size:12px;line-height:18px;display:flex}.INML2G_grid{grid-template-columns:repeat(2,minmax(0,1fr));align-items:start;gap:10px;display:grid}.INML2G_masonry{align-items:flex-start;gap:10px;display:flex}.INML2G_masonryCol{flex-direction:column;flex:1;gap:10px;min-width:0;display:flex}.INML2G_masonry>.INML2G_masonryCol>*{align-self:stretch;min-width:0}@media (max-width:680px){.INML2G_masonry{flex-direction:column}.INML2G_masonryCol{width:100%}.INML2G_grid{grid-template-columns:minmax(0,1fr)}}.INML2G_swatches{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;gap:0;height:34px;display:flex;overflow:hidden}.INML2G_themesGrid{margin-bottom:12px}.INML2G_swatches i{flex:1}.INML2G_themeToolbar{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:8px;padding:0 4px 12px;display:grid}.INML2G_themeSearch{box-sizing:border-box;width:100%;min-width:0}.INML2G_themeToolbarActions{justify-content:flex-end;align-items:center;gap:8px;display:flex}.INML2G_themeFullscreenBtn.INML2G_themeFullscreenBtn{width:28px;min-width:28px;padding:0}.INML2G_themeResultBar{min-height:24px;color:var(--dsw-alias-label-tertiary,#8b93a1);align-items:center;padding:0 4px 8px;font-size:12px;line-height:18px;display:flex}.INML2G_themeGallery{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch;gap:10px;display:grid}.INML2G_themeCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);border-radius:8px;flex-direction:column;min-width:0;transition:border-color .16s cubic-bezier(.16,1,.3,1),box-shadow .16s cubic-bezier(.16,1,.3,1),transform .16s cubic-bezier(.16,1,.3,1);display:flex;overflow:hidden}.INML2G_themeCard:hover{border-color:var(--dsw-alias-border-l3,#d9dde3);box-shadow:var(--dsw-shadow-lv1,0 4px 12px #1f232814);transform:translateY(-1px)}.INML2G_themeCover{aspect-ratio:16/10;border:0;border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;color:var(--dsw-alias-label-secondary,#6b7280);cursor:zoom-in;border-radius:0;padding:0;display:block;position:relative;overflow:hidden}.INML2G_themeCover img{object-fit:contain;background:var(--dsw-alias-bg-layer-2,#f3f4f6);width:100%;height:100%;transition:transform .18s cubic-bezier(.16,1,.3,1);display:block}.INML2G_themeCover:hover img{transform:scale(1.012)}.INML2G_themeCover:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary,#4f6ef7);outline-offset:-3px}.INML2G_themeCoverEmpty{cursor:default;color:var(--dsw-alias-label-tertiary,#8b93a1);flex-direction:column;justify-content:center;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.INML2G_themePreviewAction,.INML2G_themePreviewCount{color:#fff;-webkit-backdrop-filter:blur(8px);background:#14181fc7;border:1px solid #ffffff57;border-radius:4px;align-items:center;height:24px;padding:0 8px;font-size:11px;line-height:16px;display:inline-flex;position:absolute;bottom:8px}.INML2G_themePreviewAction{gap:4px;right:8px}.INML2G_themePreviewCount{left:8px}.INML2G_themeCardBody{flex-direction:column;flex:1;gap:8px;padding:12px;display:flex}.INML2G_themeCardHead{align-items:flex-start;gap:8px;min-width:0;display:flex}.INML2G_themeIdentity{flex:1;min-width:0}.INML2G_themeStatus,.INML2G_themeStatusMuted{white-space:nowrap;border-radius:4px;flex:none;align-items:center;min-height:22px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.INML2G_themeStatus{background:var(--dsw-alias-state-success-tertiary,#16a34a1a);color:var(--dsw-alias-state-success-primary,#15803d)}.INML2G_themeStatusMuted{background:var(--dsw-alias-bg-layer-2,#f3f4f6);color:var(--dsw-alias-label-secondary,#6b7280)}.INML2G_themeDescription{min-height:36px;color:var(--dsw-alias-label-tertiary,#8b93a1);-webkit-line-clamp:3;-webkit-box-orient:vertical;margin:0;font-size:12px;line-height:18px;display:-webkit-box;overflow:hidden}.INML2G_themeCardFooter{justify-content:space-between;align-items:center;gap:8px;margin-top:auto;padding-top:4px;display:flex}.INML2G_themeLifecycle{min-width:0;color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:18px;overflow:hidden}.INML2G_themeActions{flex-wrap:wrap;justify-content:flex-end;align-items:center;gap:8px;margin-left:auto;display:flex}@container (width<=900px){.INML2G_themeGallery{grid-template-columns:repeat(3,minmax(0,1fr))}}@container (width<=680px){.INML2G_themeGallery{grid-template-columns:repeat(2,minmax(0,1fr))}}@container (width<=460px){.INML2G_themeGallery{grid-template-columns:minmax(0,1fr)}}@container (width<=420px){.INML2G_sub{grid-template-columns:minmax(0,1fr) auto;align-items:start;gap:2px 8px;display:grid}.INML2G_sub>span:first-child{grid-area:1/1}.INML2G_sub>.INML2G_grow{display:none}.INML2G_submitLink{grid-area:2/1}.INML2G_exportLogBtn{flex-shrink:0;grid-area:1/2/span 2}.INML2G_themeToolbar{grid-template-columns:minmax(0,1fr)}.INML2G_themeCardHead{flex-wrap:wrap}.INML2G_themeStatus,.INML2G_themeStatusMuted{order:3}}@container (width<=280px){.INML2G_themeCardFooter{flex-direction:column;align-items:flex-start}.INML2G_themeActions{justify-content:flex-start;width:100%;margin-left:0}}@media (max-width:560px){[role=dialog]:has([data-dsh-market-root])>nav{display:none}[role=dialog]:has([data-dsh-market-root])>div{flex:100%;width:100%;min-width:0}}[role=dialog]:has([data-dsh-market-fullscreen=true]){border-radius:0;width:100vw;max-width:none;height:100vh;max-height:none;position:fixed;top:0;bottom:0;left:0;right:0}@media (prefers-reduced-motion:reduce){.INML2G_themeCard,.INML2G_themeCover img{transition:none}.INML2G_themeCard:hover{transform:none}}.INML2G_card{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;align-self:start;gap:12px;padding:12px 14px;display:flex}.INML2G_row1{align-items:flex-start;gap:10px;min-width:0;display:flex}.INML2G_cardAction{flex-shrink:0;align-items:center;display:inline-flex}.INML2G_installBtn.INML2G_installBtn{min-width:64px}.INML2G_av{color:#fff;object-fit:cover;background:var(--dsw-alias-bg-layer-2,#f3f4f6);border-radius:50%;flex-shrink:0;place-items:center;width:16px;height:16px;font-size:9px;font-weight:700;display:grid}.INML2G_nm{text-overflow:ellipsis;white-space:nowrap;font-size:15px;font-weight:600;line-height:22px;overflow:hidden}.INML2G_nmLink{color:inherit;text-decoration:none;display:block}.INML2G_nmLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.INML2G_repoMark{color:var(--dsw-alias-label-tertiary,#8b93a1);vertical-align:-1px;flex-shrink:0;margin-left:5px}.INML2G_nmLink:hover .INML2G_repoMark{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_byline{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.INML2G_meta{color:var(--dsw-alias-label-secondary,#9ca3af);margin-top:2px;font-size:11px}.INML2G_metaInline{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px}.INML2G_owner{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;min-width:44px;font-size:11px;overflow:hidden}.INML2G_desc{color:var(--dsw-alias-label-tertiary,#8b93a1);margin:0;font-size:12px;line-height:18px}.INML2G_descClamp{-webkit-line-clamp:5;-webkit-box-orient:vertical;display:-webkit-box;overflow:hidden}.INML2G_descToggle{width:20px;height:16px;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;background:0 0;border:none;justify-content:center;align-items:center;margin-top:2px;padding:0;display:flex}.INML2G_descToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_foot{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.INML2G_foot .INML2G_metaInline,.INML2G_foot .INML2G_src{white-space:nowrap}.INML2G_grow{flex:1}.INML2G_titleRow{align-items:center;gap:10px;display:flex}.INML2G_version{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px;line-height:20px}.INML2G_repoLink{color:var(--dsw-alias-label-tertiary,#8b93a1);flex-shrink:0;font-size:12px;line-height:20px;text-decoration:none}.INML2G_repoLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_noteRow{flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex}.INML2G_noteMine{color:var(--dsw-alias-label-primary,#1f2328)}.INML2G_noteToggle{font:inherit;color:var(--dsw-alias-label-tertiary,#8b93a1);cursor:pointer;white-space:nowrap;background:0 0;border:none;flex-shrink:0;padding:0;font-size:11px;line-height:16px}.INML2G_noteToggle:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.INML2G_noteAction{color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:4px;align-items:center;padding:0 5px;font-weight:600;text-decoration:none;display:inline-flex}.INML2G_noteAction:hover{color:var(--dsw-alias-label-primary,#1f2328);border-color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:none}.INML2G_noteEdit{flex-wrap:wrap;align-items:center;gap:6px;min-width:0;margin-top:2px;display:flex}.INML2G_noteInput{flex:1;min-width:160px}.INML2G_descTight{min-height:0}.INML2G_src{color:var(--dsw-alias-label-secondary,#9ca3af);font-size:11px;text-decoration:none}.INML2G_src:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_dot{vertical-align:2px;margin-left:5px}.INML2G_act{flex-wrap:wrap;align-items:center;gap:6px;margin-top:6px;font-size:11px;display:flex}.INML2G_actLive{color:var(--dsw-alias-state-success-primary,#16a34a);align-items:center;gap:4px;font-weight:600;display:inline-flex}.INML2G_actWarn{color:var(--dsw-alias-state-warn-primary,#b45309);align-items:center;gap:4px;font-weight:600;display:inline-flex}.INML2G_actBroken{color:var(--dsw-alias-state-error-primary,#dc2626);align-items:center;gap:4px;font-weight:600;display:inline-flex}.INML2G_actWhy{color:var(--dsw-alias-label-secondary,#6b7280);margin-top:2px}.INML2G_loading{color:var(--dsw-alias-label-secondary,#9ca3af);flex-direction:column;align-items:center;gap:12px;padding:48px;font-size:13px;display:flex}.INML2G_spin{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;animation:.8s linear infinite INML2G_sp;display:inline-flex}.INML2G_logoMark{color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;display:inline-flex}.INML2G_logoPlug{transform-box:fill-box;transform-origin:50%;animation:1.5s cubic-bezier(.4,0,.2,1) infinite INML2G_dshmPlug}@keyframes INML2G_dshmPlug{0%,12%{transform:rotate(9deg)}45%,62%{transform:translate(-1.28px,1.27px)rotate(0)}95%,to{transform:rotate(9deg)}}@media (prefers-reduced-motion:reduce){.INML2G_logoPlug,.INML2G_spin{animation:1.5s ease-in-out infinite INML2G_dshmPlugFade}}@keyframes INML2G_dshmPlugFade{0%,to{opacity:1}50%{opacity:.35}}@keyframes INML2G_sp{to{transform:rotate(360deg)}}.INML2G_progress{background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:8px;flex-wrap:wrap;align-items:center;gap:9px;margin:0;padding:8px 12px;font-size:12px;display:flex}.INML2G_bar{background:var(--dsw-alias-border-l1,#e5e7eb);border-radius:99px;width:100%;height:4px;overflow:hidden}.INML2G_barFill{background:var(--dsw-alias-brand-primary,#4f6ef7);border-radius:99px;height:100%;transition:width .6s}.INML2G_barWave{width:30%;animation:1.2s ease-in-out infinite INML2G_dshmSlide}@keyframes INML2G_dshmSlide{0%{margin-left:-30%}to{margin-left:100%}}.INML2G_irow .INML2G_progress{margin-top:8px}.INML2G_progress code{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.INML2G_empty{color:var(--dsw-alias-label-secondary,#9ca3af);text-align:center;padding:32px;font-size:13px}.INML2G_err{color:var(--dsw-alias-state-error-primary,#dc2626);white-space:pre-wrap;word-break:break-all;margin:8px 0;font-size:12px}.INML2G_cardBlocked{border-color:var(--dsw-alias-state-error-primary,#dc2626)}.INML2G_conflictHead{align-items:flex-start;gap:8px;display:flex}.INML2G_conflictIcon{color:var(--dsw-alias-state-error-primary,#dc2626);flex-shrink:0;margin-top:1px}.INML2G_conflictTitle{color:var(--dsw-alias-state-error-primary,#dc2626);font-size:13px;font-weight:600;line-height:18px}.INML2G_conflictBody{margin:0;font-size:12px;line-height:19px}.INML2G_roster{background:var(--dsw-alias-border-l2,#e5e7eb);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-direction:column;gap:1px;display:flex;overflow:hidden}.INML2G_rosterRow{background:var(--dsw-alias-bg-layer-1,#fff);align-items:center;gap:8px;padding:7px 10px;display:flex}.INML2G_rosterMain{flex-direction:column;min-width:0;display:flex}.INML2G_rosterName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;font-weight:600;overflow:hidden}.INML2G_rosterAuthor{color:var(--dsw-alias-label-secondary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;font-size:10.5px;overflow:hidden}.INML2G_rosterTag{border-radius:4px;flex-shrink:0;margin-left:auto;padding:1px 6px;font-size:10.5px;font-weight:600}.INML2G_rosterTagKeep{color:var(--dsw-alias-state-success-primary,#16a34a);background:#16a34a1f}.INML2G_rosterTagDrop{color:var(--dsw-alias-state-error-primary,#dc2626);background:#dc26261f}.INML2G_rosterRowOut .INML2G_rosterName{text-decoration:line-through}.INML2G_rosterRowOut{opacity:.62}.INML2G_rosterSplit{background:var(--dsw-alias-border-l2,#e5e7eb);height:1px}.INML2G_reassure{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:5px;margin:0;font-size:11.5px;line-height:17px;display:flex}.INML2G_reassureOk{color:var(--dsw-alias-state-success-primary,#16a34a);flex-shrink:0}.INML2G_conflictWhy{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;margin-top:2px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:17px}.INML2G_conflictWhyText{margin-top:5px;font-family:-apple-system,BlinkMacSystemFont,PingFang SC,sans-serif}.INML2G_choices{flex-direction:column;gap:7px;display:flex}.INML2G_choice{text-align:left;font:inherit;cursor:pointer;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:9px;align-items:flex-start;gap:9px;padding:9px 11px;display:flex}.INML2G_choice:has(input:disabled){cursor:default;opacity:.6}.INML2G_choiceOn{border-color:var(--dsw-alias-brand-primary,#4f6ef7);background:var(--dsw-alias-bg-layer-2,#f5f7ff)}.INML2G_choiceRadio{width:13px;height:13px;accent-color:var(--dsw-alias-brand-primary,#4f6ef7);flex-shrink:0;margin:2px 0 0}.INML2G_choiceMain{flex-direction:column;gap:3px;min-width:0;display:flex}.INML2G_choiceTitle{font-size:12px;font-weight:600;line-height:17px}.INML2G_choiceNote{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px;line-height:16px}.INML2G_choiceSafe{color:var(--dsw-alias-state-success-primary,#16a34a)}.INML2G_stateTag{white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-height:20px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:5px;flex-shrink:0;align-items:center;gap:5px;padding:1px 7px;font-size:11px;line-height:16px;display:inline-flex}.INML2G_stateTag[data-on=true]{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.INML2G_stateDot{background:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:999px;flex:none;width:6px;height:6px}.INML2G_stateDot[data-on=true]{background:var(--dsw-alias-state-success-primary,#16a34a)}.INML2G_metaTag{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:0;max-width:100%;min-height:20px;color:var(--dsw-alias-label-tertiary,#8b93a1);border-radius:5px;flex-shrink:1;padding:1px 7px;font-size:11px;line-height:18px;display:inline-block;overflow:hidden}.INML2G_metaTagOk{color:var(--dsw-alias-state-success-primary,#16a34a);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#16a34a) 10%, transparent)}.INML2G_nameLink{color:inherit;text-decoration:none}.INML2G_irowName{text-overflow:clip;flex-wrap:wrap;align-items:baseline;gap:6px;min-width:0;display:flex;overflow:visible}.INML2G_irowNameText{overflow-wrap:anywhere;white-space:normal;min-width:0}.INML2G_irowName>.INML2G_owner{flex:none}.INML2G_nameLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7);text-decoration:underline}.INML2G_opWrap{flex-shrink:0;display:inline-flex;position:relative}.INML2G_opEntry{font:inherit;cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:7px;align-items:center;gap:6px;padding:4px 10px;font-size:12px;display:inline-flex;position:relative}.INML2G_opEntryQuiet{color:var(--dsw-alias-label-secondary,#6b7280);background:0 0;border-color:#0000}.INML2G_opEntryAlert{border-color:var(--dsw-alias-state-error-primary,#dc2626);color:var(--dsw-alias-state-error-primary,#dc2626)}.INML2G_opDot{background:var(--dsw-alias-state-error-primary,#dc2626);border-radius:99px;width:8px;height:8px;position:absolute;top:-3px;right:-3px}.INML2G_opPanel{z-index:40;background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l3,#d9dde3);border-radius:12px;width:460px;max-width:86vw;max-height:70vh;position:absolute;top:calc(100% + 6px);right:0;overflow-y:auto;box-shadow:0 20px 52px #00000047}.INML2G_opHead{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:center;gap:8px;padding:9px 14px;display:flex}.INML2G_opPanelTitle{font-size:12.5px;font-weight:600}.INML2G_opCloseBtn.INML2G_opCloseBtn{min-width:0;color:var(--dsw-alias-label-secondary,#6b7280);padding:0 6px}.INML2G_opAggregate{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-2,#f7f8fa);padding:9px 14px}.INML2G_opAggregateTop{font-variant-numeric:tabular-nums;font-size:12px;font-weight:600}.INML2G_opAggregateHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:10.5px}.INML2G_opRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:flex-start;gap:9px;padding:9px 14px;display:flex}.INML2G_opRow:last-child{border-bottom:none}.INML2G_opRowAlert{background:#dc26260f}.INML2G_opIcon{flex-shrink:0;place-items:center;width:14px;margin-top:1px;display:grid}.INML2G_opQueuedIcon{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px}.INML2G_opMain{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.INML2G_opTop{align-items:baseline;gap:6px;min-width:0;display:flex}.INML2G_opVerb{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:12px}.INML2G_opName{text-overflow:ellipsis;white-space:nowrap;font-size:12px;font-weight:600;overflow:hidden}.INML2G_opStatus{color:var(--dsw-alias-label-tertiary,#8b93a1);overflow-wrap:anywhere;font-size:10.5px;line-height:16px}.INML2G_opStatusBad{color:var(--dsw-alias-state-error-primary,#dc2626)}.INML2G_opActions{flex-shrink:0;align-items:center;gap:6px;margin-top:1px;display:flex}.INML2G_opDecision{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;margin-top:8px;padding-top:8px;display:flex}.INML2G_opDecisionFoot{align-items:center;gap:8px;display:flex}.INML2G_conflictDetailsToggle{font:inherit;cursor:pointer;color:var(--dsw-alias-label-tertiary,#8b93a1);background:0 0;border:none;align-items:center;gap:4px;padding:2px 0;font-size:11px;display:inline-flex}.INML2G_conflictDetailsToggle:hover{color:var(--dsw-alias-label-secondary,#6b7280)}.INML2G_opEmpty{text-align:center;color:var(--dsw-alias-label-secondary,#6b7280);padding:30px 14px;font-size:12px}.INML2G_opEmptyHint{color:var(--dsw-alias-label-tertiary,#8b93a1);margin-top:4px;font-size:11px}.INML2G_cardBlockedMark{font:inherit;cursor:pointer;color:var(--dsw-alias-state-error-primary,#dc2626);border:1px solid var(--dsw-alias-state-error-primary,#dc2626);background:#dc262614;border-radius:7px;align-items:center;gap:5px;padding:4px 9px;font-size:11px;display:inline-flex}.INML2G_dangerBtn.INML2G_dangerBtn{color:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626)}.INML2G_dangerBtn.INML2G_dangerBtn:hover:not(:disabled){background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.INML2G_dangerArmed.INML2G_dangerArmed{background:var(--dsw-alias-state-error-primary,#dc2626);border-color:var(--dsw-alias-state-error-primary,#dc2626);color:#fff}.INML2G_retryBtn{margin-top:4px}.INML2G_irow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:10px;flex-direction:column;gap:10px;min-width:0;padding:12px 14px;display:flex}.INML2G_irowActions{flex-wrap:wrap;justify-content:flex-start;align-items:center;gap:8px;min-width:0;display:flex}.INML2G_irowTrailing{flex-wrap:nowrap;align-items:center;gap:8px;min-width:0;display:inline-flex}.INML2G_irowMissing{filter:grayscale();opacity:.5}.INML2G_irow>.INML2G_src,.INML2G_irow>.INML2G_owner,.INML2G_irow button{white-space:nowrap;flex-shrink:0}.INML2G_tabSearchRow{padding:0 4px 6px;display:flex}.INML2G_tabSearch{width:100%}.INML2G_spec{color:var(--dsw-alias-label-secondary,#9ca3af);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:11px}.INML2G_specTag{white-space:nowrap;border-radius:4px;flex-shrink:0;align-items:center;height:16px;padding:0 5px;font-size:10px;font-weight:600;display:inline-flex}.INML2G_specTagGit{color:#0b7285;background:#12a3c41f}.INML2G_specTagFile{color:#b07d1b;background:#f0b42924}.INML2G_backupCheckList .INML2G_grow{white-space:nowrap;text-overflow:ellipsis;flex:70%;min-width:0;overflow:hidden}.INML2G_backupCheckList .INML2G_spec{text-align:right;white-space:nowrap;text-overflow:ellipsis;flex:0 30%;max-width:30%;overflow:hidden}.INML2G_staleAction{margin-top:8px}.INML2G_pct{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;font-size:11px;font-weight:600}.INML2G_pager{flex-wrap:wrap;justify-content:space-between;align-items:center;gap:12px;margin:16px 0 4px;display:flex}.INML2G_pagerPages{flex-wrap:wrap;flex:1;justify-content:center;align-items:center;gap:6px;min-width:0;display:flex}.INML2G_pageEllipsis{color:var(--dsw-alias-label-secondary,#9ca3af);padding:0 2px;font-size:12px}.INML2G_pageInfo{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;font-size:12px}.INML2G_depBadge{border:1px solid var(--dsw-alias-state-warn-primary,#b45309);color:var(--dsw-alias-state-warn-primary,#b45309);white-space:nowrap;border-radius:4px;flex-shrink:0;margin-left:6px;padding:1px 6px;font-size:11px;font-weight:600;line-height:16px}.INML2G_deprecate{color:var(--dsw-alias-state-warn-primary,#b45309);background:var(--dsw-alias-bg-layer-2,#fdf3e3);border:1px solid var(--dsw-alias-border-l2,#f3e3c3);border-radius:8px;margin:0;padding:8px 10px;font-size:12px;line-height:18px}.INML2G_deprecate a{color:var(--dsw-alias-state-warn-primary,#b45309);text-decoration:underline}.INML2G_deprecate .INML2G_src{margin-left:8px}.INML2G_depLine{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.INML2G_switch{border:1px solid var(--dsw-alias-border-l2,#d9dde3);background:var(--dsw-alias-bg-layer-2,#e5e7eb);cursor:pointer;border-radius:99px;flex-shrink:0;width:38px;height:22px;padding:0;transition:background .15s,border-color .15s;position:relative}.INML2G_switchOn{background:var(--dsw-alias-state-success-primary,#16a34a);border-color:var(--dsw-alias-state-success-primary,#16a34a)}.INML2G_switchMixed{background:var(--dsw-alias-state-warn-primary,#b45309);border-color:var(--dsw-alias-state-warn-primary,#b45309)}.INML2G_switchKnob{background:#fff;border-radius:99px;width:16px;height:16px;transition:left .15s;position:absolute;top:2px;left:2px;box-shadow:0 1px 2px #00000040}.INML2G_switchOn .INML2G_switchKnob,.INML2G_switchMixed .INML2G_switchKnob{left:18px}.INML2G_switch:disabled{opacity:.5;cursor:default}.INML2G_viewBar{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;align-items:center;gap:2px;width:fit-content;margin-bottom:12px;padding:2px;display:flex}.INML2G_viewBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;white-space:nowrap;background:0 0;border:none;border-radius:6px;padding:4px 10px;font-size:12px;line-height:18px}.INML2G_viewBtn:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_viewOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.INML2G_groupRow{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;margin-bottom:10px;padding:12px 14px}.INML2G_groupHead{align-items:center;gap:10px;min-width:0;display:flex}.INML2G_groupName{text-overflow:ellipsis;white-space:nowrap;font-size:13px;font-weight:600;line-height:20px;overflow:hidden}.INML2G_groupActions{flex-shrink:0;align-items:center;gap:6px;display:flex}.INML2G_groupMembers{flex-direction:column;gap:6px;margin-top:10px;display:flex}.INML2G_groupMember{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;align-items:center;gap:8px;padding:6px 8px;font-size:12px;line-height:18px;display:flex}.INML2G_groupMember .INML2G_nm{flex:1;min-width:0;font-size:12px}.INML2G_groupAddPanel{border-top:1px dashed var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:6px;margin-top:10px;padding-top:10px;display:flex}.INML2G_groupCreate{align-items:center;gap:8px;margin-bottom:10px;display:flex}.INML2G_inlineInput{flex:1;min-width:120px}.INML2G_assignRow{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.INML2G_assignSelect{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-1,#fff);color:var(--dsw-alias-label-primary,#1f2328);font:inherit;border-radius:6px;padding:3px 6px;font-size:12px;line-height:18px}.INML2G_groupHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:11px}.INML2G_sectAction{color:var(--dsw-alias-label-secondary,#6b7280);align-items:center;gap:8px;margin:14px 2px 8px;font-size:12px;font-weight:600;display:flex}.INML2G_backupGrid{grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:12px;display:grid}.INML2G_backupCard{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:10px;padding:16px;display:flex}.INML2G_backupCard h3{margin:0;font-size:14px}.INML2G_backupCard p{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.INML2G_backupActions{flex-wrap:wrap;gap:8px;display:flex;position:relative}.INML2G_hiddenFile{opacity:0;pointer-events:none;width:1px;height:1px;position:absolute}.INML2G_backupInput{box-sizing:border-box;width:100%}.INML2G_backupCheck{cursor:pointer;align-items:center;gap:6px;font-size:12px;display:flex}.INML2G_backupWarn{margin:0;font-size:12px;line-height:18px;color:var(--dsw-alias-state-warn-primary,#b45309)!important}.INML2G_backupMessage{color:var(--dsw-alias-label-secondary,#6b7280);grid-column:1/-1;font-size:12px}.INML2G_backupCheckList{flex-direction:column;gap:6px;max-height:260px;margin:10px 0 4px;padding-right:4px;display:flex;overflow-y:auto}.INML2G_backupCheckList .INML2G_backupCheck{justify-content:space-between;gap:8px}.INML2G_diagPage{flex-direction:column;gap:12px;height:100%;min-height:0;display:flex;overflow-y:auto}.INML2G_diagSummary{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-wrap:wrap;align-items:center;gap:12px;padding:10px 14px;font-size:12px;display:flex}.INML2G_diagSummaryItem{color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;align-items:center;gap:6px;display:inline-flex}.INML2G_diagSummaryMeta{color:var(--dsw-alias-label-tertiary,#9ca3af);text-overflow:ellipsis;white-space:nowrap;max-width:320px;font-family:ui-monospace,Menlo,monospace;font-size:11px;overflow:hidden}.INML2G_diagSection{background:var(--dsw-alias-bg-layer-1,#fff);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:12px;flex-direction:column;gap:8px;padding:12px 14px;display:flex}.INML2G_diagSection h3{color:var(--dsw-alias-label-primary,#1f2328);margin:0;font-size:13px;font-weight:600}.INML2G_diagCount{color:var(--dsw-alias-label-tertiary,#9ca3af);font-size:11px;font-weight:400}.INML2G_diagEmpty{color:var(--dsw-alias-label-secondary,#9ca3af);padding:8px 0;font-size:12px}.INML2G_diagBundle{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);flex-direction:column;gap:6px;padding-top:8px;display:flex}.INML2G_diagBundle:first-of-type{border-top:none;padding-top:0}.INML2G_diagRow{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;font-size:12px;line-height:18px;display:flex}.INML2G_diagMeta{align-items:baseline;gap:8px;min-width:0;font-size:12px;display:flex}.INML2G_diagKey{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;min-width:64px;font-size:11px}.INML2G_diagVal{color:var(--dsw-alias-label-primary,#1f2328);overflow-wrap:anywhere;min-width:0;font-family:ui-monospace,Menlo,monospace;font-size:12px;font-weight:500}.INML2G_diagIndex{background:var(--dsw-alias-bg-layer-2,#f3f4f6);min-width:18px;height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;justify-content:center;align-items:center;font-size:11px;font-weight:600;display:inline-flex}.INML2G_diagArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.INML2G_diagBadgeOfficial{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.INML2G_diagBadgeCommunity{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.INML2G_diagBadgeShadow{background:var(--dsw-alias-state-error-primary,#dc2626);color:#fff;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.INML2G_diagBadgeWarn{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.INML2G_diagBadgeInfo{background:var(--dsw-alias-bg-layer-2,#f3f4f6);height:18px;color:var(--dsw-alias-label-secondary,#6b7280);white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;padding:0 8px;font-size:11px;display:inline-flex}.INML2G_diagList{flex-direction:column;gap:6px;display:flex}.INML2G_sectionOverview{color:var(--dsw-alias-label-tertiary,#8b93a1);text-overflow:ellipsis;white-space:nowrap;max-width:100%;padding:2px 0 6px;font-size:12px;line-height:18px;overflow:hidden}.INML2G_diagAlert{color:var(--dsw-alias-state-warn-primary,#b45309)}.INML2G_ovRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.INML2G_ovArrow{color:var(--dsw-alias-label-tertiary,#9ca3af);flex-shrink:0;font-size:12px}.INML2G_ovByTag{background:var(--dsw-alias-brand-primary,#4f6ef7);color:#fff;text-overflow:ellipsis;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;max-width:260px;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex;overflow:hidden}.INML2G_ovFrom{color:var(--dsw-alias-label-secondary,#6b7280);text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:12px;overflow:hidden}.INML2G_orphRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-wrap:wrap;align-items:center;gap:8px;min-width:0;padding:6px 10px;font-size:12px;line-height:18px;display:flex}.INML2G_orphBadge{background:var(--dsw-alias-state-warn-primary,#b45309);color:#fff;white-space:nowrap;border-radius:9px;flex-shrink:0;align-items:center;height:18px;padding:0 8px;font-size:11px;font-weight:600;display:inline-flex}.INML2G_dragHandle{width:20px;height:20px;color:var(--dsw-alias-label-tertiary,#9ca3af);cursor:grab;-webkit-user-select:none;user-select:none;flex-shrink:0;justify-content:center;align-items:center;font-size:12px;line-height:20px;display:inline-flex}.INML2G_dragOver{outline:2px dashed var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:2px;background:var(--dsw-alias-bg-layer-2,#f0f2f8);border-radius:8px}.INML2G_dragging{opacity:.45;background:var(--dsw-alias-bg-layer-2,#f3f4f6)}.INML2G_collapseHead{font:inherit;color:var(--dsw-alias-label-primary,#1f2328);cursor:pointer;text-align:left;background:0 0;border:none;align-items:center;gap:8px;width:100%;padding:0;font-size:13px;font-weight:600;display:flex}.INML2G_collapseIcon{color:var(--dsw-alias-label-secondary,#6b7280);flex-shrink:0;display:inline-flex}.INML2G_collapseTitle{flex:1;min-width:0}.INML2G_collapseBody{border-top:1px solid var(--dsw-alias-border-l2,#f0f1f3);overflow-wrap:anywhere;flex-direction:column;gap:10px;min-width:0;margin-top:8px;padding-top:10px;display:flex}.INML2G_orderPanel{flex-direction:column;gap:10px;min-width:0;display:flex}.INML2G_panelNote{color:var(--dsw-alias-label-secondary,#6b7280);margin:0;font-size:12px;line-height:18px}.INML2G_panelActions{flex-wrap:wrap;align-items:center;gap:8px;display:flex}.INML2G_presetList{flex-direction:column;gap:6px;min-width:0;display:flex}.INML2G_presetRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:6px;min-width:0;max-width:100%;padding:8px 10px;font-size:12px;line-height:18px;display:flex}.INML2G_presetName{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:13px;font-weight:600;overflow:hidden}.INML2G_snapList{flex-direction:column;gap:6px;min-width:0;display:flex}.INML2G_snapRow{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-radius:8px;flex-direction:column;align-items:stretch;gap:8px;padding:10px 12px;font-size:12px;line-height:18px;display:flex}.INML2G_snapMeta{flex-wrap:wrap;align-items:center;gap:8px;min-width:0;display:flex}.INML2G_snapConfirmText{color:var(--dsw-alias-state-warn-primary,#b45309);margin:0;font-size:12px;line-height:18px}.INML2G_confirmRow{flex-wrap:wrap;align-items:center;gap:6px;display:inline-flex}.INML2G_fixFallback{flex-direction:column;gap:6px;margin:8px 0;display:flex}.INML2G_fixFallbackText{box-sizing:border-box;width:100%;color:var(--dsw-alias-label-primary,#1f2328);background:var(--dsw-alias-bg-layer-2,#f3f4f6);border:1px solid var(--dsw-alias-border-l2,#e5e7eb);resize:vertical;white-space:pre-wrap;word-break:break-all;border-radius:6px;padding:8px 10px;font-family:ui-monospace,Menlo,monospace;font-size:11px;line-height:16px}.INML2G_setCard{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);background:var(--dsw-alias-bg-layer-3,#fff);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.INML2G_setCard:hover{border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.INML2G_setCardOpen{background:var(--dsw-alias-bg-layer-2,#f7f8fa);border-color:var(--dsw-alias-label-dimmed,#c8ccd4)}.INML2G_setHeader{-webkit-appearance:none;appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.INML2G_setHeader:focus-visible{outline:2px solid var(--dsw-alias-brand-primary,#4f6ef7);outline-offset:-2px}.INML2G_setHeadText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.INML2G_setName{color:var(--dsw-alias-label-primary,#1f2328);font-size:15px;font-weight:600;line-height:1.4}.INML2G_setDesc{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:13px;line-height:1.5}.INML2G_setChevron{color:var(--dsw-alias-label-tertiary,#8b93a1);flex:none;transition:transform .16s;display:inline-flex}.INML2G_setChevronOpen{transform:rotate(180deg)}.INML2G_setBody{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);margin:0 16px;padding-bottom:8px}.INML2G_setRow{align-items:center;gap:12px;padding:12px 0;display:flex}.INML2G_setRow+.INML2G_setRow{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb)}.INML2G_setLabelBox{flex-direction:column;flex:1;gap:3px;min-width:0;display:flex}.INML2G_setLabel{font-size:13px;line-height:20px}.INML2G_setHint{color:var(--dsw-alias-label-tertiary,#8b93a1);font-size:12px;line-height:18px}.INML2G_setConfirm{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);flex-direction:column;gap:8px;padding:12px 0 4px;display:flex}.INML2G_setCheck{cursor:pointer;align-items:center;gap:8px;font-size:12px;line-height:18px;display:flex}.INML2G_setActions{border-top:1px solid var(--dsw-alias-border-l2,#e5e7eb);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.INML2G_setDanger{color:var(--dsw-alias-state-error-primary,#dc2626)}.INML2G_setSeg{border:1px solid var(--dsw-alias-border-l2,#e5e7eb);border-radius:8px;flex-shrink:0;gap:2px;padding:2px;display:inline-flex}.INML2G_setSegBtn{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;background:0 0;border:none;border-radius:6px;padding:3px 10px;font-size:12px;line-height:18px}.INML2G_setSegBtn:disabled{cursor:default;opacity:.5}.INML2G_setSegOn{background:var(--dsw-alias-bg-layer-2,#eef0f4);color:var(--dsw-alias-label-primary,#1f2328);font-weight:600}.INML2G_setBetaTag{background:var(--dsw-alias-bg-module-platform,#eef0f4);color:var(--dsw-alias-label-secondary,#6b7280);border-radius:9px;margin-left:6px;padding:0 6px;font-size:11px;font-weight:600;line-height:17px}.INML2G_commentsLink{cursor:pointer;white-space:nowrap;color:var(--dsw-alias-label-secondary,#9ca3af);background:0 0;border:0;padding:0;font-size:11px;line-height:16px}.INML2G_commentsLink:hover{color:var(--dsw-alias-brand-primary,#4f6ef7)}.INML2G_commentsNote{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 8px;font-size:11px;line-height:16px}.INML2G_commentsStatus{color:var(--dsw-alias-label-secondary,#9ca3af);margin:0;font-size:12px}.INML2G_commentsStatus:empty{display:none}.INML2G_commentsError{color:var(--dsw-alias-label-primary,#1f2328);margin:0 0 8px;font-size:12px}.INML2G_commentsFail{flex-direction:column;align-items:flex-start;gap:8px;padding:12px 0;display:flex}.INML2G_commentsMount{width:100%;min-height:240px;max-height:56vh;overflow:auto}.INML2G_commentsMount iframe{width:100%}.INML2G_notesLink{font:inherit;color:var(--dsw-alias-label-secondary,#6b7280);cursor:pointer;text-align:left;background:0 0;border:none;margin:2px 0 0;padding:0;font-size:12px;line-height:18px;display:block}.INML2G_notesLink:hover{color:var(--dsw-alias-label-primary,#1f2328)}.INML2G_notesBody{flex-direction:column;gap:8px;min-width:0;display:flex}.INML2G_notesRange{align-items:center;gap:8px;margin-bottom:4px;font-size:12px;line-height:18px;display:flex}.INML2G_notesArrow{color:var(--dsw-alias-label-tertiary,#8b93a1)}.INML2G_notesMeta{letter-spacing:.02em;text-transform:uppercase;color:var(--dsw-alias-label-secondary,#6b7280);flex-wrap:wrap;align-items:baseline;gap:6px;margin-top:12px;font-size:12px;line-height:18px;display:flex}.INML2G_notesPre{white-space:pre-wrap;word-break:break-word;background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:8px;max-height:40vh;margin:0;padding:10px 12px;font-size:13px;line-height:20px;overflow:auto}.INML2G_notesList{flex-direction:column;gap:6px;margin:0;padding-left:18px;font-size:13px;line-height:20px;display:flex}.INML2G_notesRendered{flex-direction:column;gap:6px;min-width:0;display:flex}.INML2G_notesH{margin-top:6px;font-size:13px;font-weight:650;line-height:20px}.INML2G_notesP{font-size:13px;line-height:20px}.INML2G_notesCode{font-family:var(--dsw-alias-font-mono,ui-monospace,monospace);background:var(--dsw-alias-bg-layer-2,#eef0f4);border-radius:5px;padding:1px 5px;font-size:12px}.INML2G_notesList{flex-direction:column;margin:0;padding:0;list-style:none;display:flex}.INML2G_notesRow{border-bottom:1px solid var(--dsw-alias-border-l2,#e5e7eb);align-items:baseline;gap:12px;padding:6px 0;display:flex}.INML2G_notesRow:last-child{border-bottom:none}.INML2G_notesDate{color:var(--dsw-alias-label-tertiary,#8b93a1);font-variant-numeric:tabular-nums;flex-shrink:0;font-size:12px}.INML2G_notesMsg{word-break:break-word;word-break:break-word;-webkit-line-clamp:3;-webkit-box-orient:vertical;min-width:0;font-size:13px;line-height:20px;display:-webkit-box;overflow:hidden}.INML2G_notesSha{color:var(--dsw-alias-label-secondary,#6b7280);font-variant-numeric:tabular-nums;flex-shrink:0;margin-left:auto;font-size:12px;text-decoration:none}.INML2G_notesSha:hover{color:var(--dsw-alias-label-primary,#1f2328);text-decoration:underline}.INML2G_notesVer{color:inherit;font-weight:600;text-decoration:none}.INML2G_notesVer:hover{text-decoration:underline}";
		...
		var Market_module_css_default = {
			"act": "INML2G_act",
			"actBroken": "INML2G_actBroken",
			"actLive": "INML2G_actLive",
			"actWarn": "INML2G_actWarn",
			"actWhy": "INML2G_actWhy",
			"assignRow": "INML2G_assignRow",
			"assignSelect": "INML2G_assignSelect",
			"av": "INML2G_av",
			"backupActions": "INML2G_backupActions",
			"backupCard": "INML2G_backupCard",
			"backupCheck": "INML2G_backupCheck",
			"backupCheckList": "INML2G_backupCheckList",
			"backupGrid": "INML2G_backupGrid",
			"backupInput": "INML2G_backupInput",
			"backupMessage": "INML2G_backupMessage",
			"backupWarn": "INML2G_backupWarn",
			"banner": "INML2G_banner",
			"bannerHint": "INML2G_bannerHint",
			"bannerIcon": "INML2G_bannerIcon",
			"bar": "INML2G_bar",
			"barFill": "INML2G_barFill",
			"barWave": "INML2G_barWave",
			"body": "INML2G_body",
			"byline": "INML2G_byline",
			"card": "INML2G_card",
			"cardAction": "INML2G_cardAction",
			"cardBlocked": "INML2G_cardBlocked",
			"cardBlockedMark": "INML2G_cardBlockedMark",
			"cardShot": "INML2G_cardShot",
			"cardShots": "INML2G_cardShots",
			"cats": "INML2G_cats",
			"catsCollapsed": "INML2G_catsCollapsed",
			"catsRow": "INML2G_catsRow",
			"catsToggle": "INML2G_catsToggle",
			"catsWrap": "INML2G_catsWrap",
			"choice": "INML2G_choice",
			"choiceMain": "INML2G_choiceMain",
			"choiceNote": "INML2G_choiceNote",
			"choiceOn": "INML2G_choiceOn",
			"choiceRadio": "INML2G_choiceRadio",
			"choices": "INML2G_choices",
			"choiceSafe": "INML2G_choiceSafe",
			"choiceTitle": "INML2G_choiceTitle",
			"cmd": "INML2G_cmd",
			"collapseBody": "INML2G_collapseBody",
			"collapseHead": "INML2G_collapseHead",
			"collapseIcon": "INML2G_collapseIcon",
			"collapseTitle": "INML2G_collapseTitle",
			"commentsError": "INML2G_commentsError",
			"commentsFail": "INML2G_commentsFail",
			"commentsLink": "INML2G_commentsLink",
			"commentsMount": "INML2G_commentsMount",
			"commentsNote": "INML2G_commentsNote",
			"commentsStatus": "INML2G_commentsStatus",
			"confirmRow": "INML2G_confirmRow",
			"conflictBody": "INML2G_conflictBody",
			"conflictDetailsToggle": "INML2G_conflictDetailsToggle",
			"conflictHead": "INML2G_conflictHead",
			"conflictIcon": "INML2G_conflictIcon",
			"conflictTitle": "INML2G_conflictTitle",
			"conflictWhy": "INML2G_conflictWhy",
			"conflictWhyText": "INML2G_conflictWhyText",
			"dangerArmed": "INML2G_dangerArmed",
			"dangerBtn": "INML2G_dangerBtn",
			"depBadge": "INML2G_depBadge",
			"depLine": "INML2G_depLine",
			"deprecate": "INML2G_deprecate",
			"desc": "INML2G_desc",
			"descClamp": "INML2G_descClamp",
			"descTight": "INML2G_descTight",
			"descToggle": "INML2G_descToggle",
			"diagAlert": "INML2G_diagAlert",
			"diagArrow": "INML2G_diagArrow",
			"diagBadgeCommunity": "INML2G_diagBadgeCommunity",
			"diagBadgeInfo": "INML2G_diagBadgeInfo",
			"diagBadgeOfficial": "INML2G_diagBadgeOfficial",
			"diagBadgeShadow": "INML2G_diagBadgeShadow",
			"diagBadgeWarn": "INML2G_diagBadgeWarn",
			"diagBundle": "INML2G_diagBundle",
			"diagCount": "INML2G_diagCount",
			"diagEmpty": "INML2G_diagEmpty",
			"diagIndex": "INML2G_diagIndex",
			"diagKey": "INML2G_diagKey",
			"diagList": "INML2G_diagList",
			"diagMeta": "INML2G_diagMeta",
			"diagPage": "INML2G_diagPage",
			"diagRow": "INML2G_diagRow",
			"diagSection": "INML2G_diagSection",
			"diagSummary": "INML2G_diagSummary",
			"diagSummaryItem": "INML2G_diagSummaryItem",
			"diagSummaryMeta": "INML2G_diagSummaryMeta",
			"diagVal": "INML2G_diagVal",
			"dot": "INML2G_dot",
			"dragging": "INML2G_dragging",
			"dragHandle": "INML2G_dragHandle",
			"dragOver": "INML2G_dragOver",
			"dshmPlug": "INML2G_dshmPlug",
			"dshmPlugFade": "INML2G_dshmPlugFade",
			"dshmSlide": "INML2G_dshmSlide",
			"empty": "INML2G_empty",
			"err": "INML2G_err",
			"exportLogBtn": "INML2G_exportLogBtn",
			"fixFallback": "INML2G_fixFallback",
			"fixFallbackText": "INML2G_fixFallbackText",
			"foot": "INML2G_foot",
			"grid": "INML2G_grid",
			"groupActions": "INML2G_groupActions",
			"groupAddPanel": "INML2G_groupAddPanel",
			"groupCreate": "INML2G_groupCreate",
			"groupHead": "INML2G_groupHead",
			"groupHint": "INML2G_groupHint",
			"groupMember": "INML2G_groupMember",
			"groupMembers": "INML2G_groupMembers",
			"groupName": "INML2G_groupName",
			"groupRow": "INML2G_groupRow",
			"grow": "INML2G_grow",
			"head": "INML2G_head",
			"hiddenFile": "INML2G_hiddenFile",
			"inlineInput": "INML2G_inlineInput",
			"installBtn": "INML2G_installBtn",
			"irow": "INML2G_irow",
			"irowActions": "INML2G_irowActions",
			"irowMissing": "INML2G_irowMissing",
			"irowName": "INML2G_irowName",
			"irowNameText": "INML2G_irowNameText",
			"irowTrailing": "INML2G_irowTrailing",
			"lightbox": "INML2G_lightbox",
			"lightboxClose": "INML2G_lightboxClose",
			"lightboxDot": "INML2G_lightboxDot",
			"lightboxDotOn": "INML2G_lightboxDotOn",
			"lightboxDots": "INML2G_lightboxDots",
			"lightboxImg": "INML2G_lightboxImg",
			"lightboxNav": "INML2G_lightboxNav",
			"lightboxNext": "INML2G_lightboxNext",
			"lightboxPrev": "INML2G_lightboxPrev",
			"loading": "INML2G_loading",
			"logoMark": "INML2G_logoMark",
			"logoPlug": "INML2G_logoPlug",
			"masonry": "INML2G_masonry",
			"masonryCol": "INML2G_masonryCol",
			"meta": "INML2G_meta",
			"metaInline": "INML2G_metaInline",
			"metaTag": "INML2G_metaTag",
			"metaTagOk": "INML2G_metaTagOk",
			"modalNote": "INML2G_modalNote",
			"nameLink": "INML2G_nameLink",
			"nm": "INML2G_nm",
			"nmLink": "INML2G_nmLink",
			"noteAction": "INML2G_noteAction",
			"noteEdit": "INML2G_noteEdit",
			"noteInput": "INML2G_noteInput",
			"noteMine": "INML2G_noteMine",
			"noteRow": "INML2G_noteRow",
			"notesArrow": "INML2G_notesArrow",
			"notesBody": "INML2G_notesBody",
			"notesCode": "INML2G_notesCode",
			"notesDate": "INML2G_notesDate",
			"notesH": "INML2G_notesH",
			"notesLink": "INML2G_notesLink",
			"notesList": "INML2G_notesList",
			"notesMeta": "INML2G_notesMeta",
			"notesMsg": "INML2G_notesMsg",
			"notesP": "INML2G_notesP",
			"notesPre": "INML2G_notesPre",
			"notesRange": "INML2G_notesRange",
			"notesRendered": "INML2G_notesRendered",
			"notesRow": "INML2G_notesRow",
			"notesSha": "INML2G_notesSha",
			"notesVer": "INML2G_notesVer",
			"noteToggle": "INML2G_noteToggle",
			"okState": "INML2G_okState",
			"on": "INML2G_on",
			"opActions": "INML2G_opActions",
			"opAggregate": "INML2G_opAggregate",
			"opAggregateHint": "INML2G_opAggregateHint",
			"opAggregateTop": "INML2G_opAggregateTop",
			"opCloseBtn": "INML2G_opCloseBtn",
			"opDecision": "INML2G_opDecision",
			"opDecisionFoot": "INML2G_opDecisionFoot",
			"opDot": "INML2G_opDot",
			"opEmpty": "INML2G_opEmpty",
			"opEmptyHint": "INML2G_opEmptyHint",
			"opEntry": "INML2G_opEntry",
			"opEntryAlert": "INML2G_opEntryAlert",
			"opEntryQuiet": "INML2G_opEntryQuiet",
			"opHead": "INML2G_opHead",
			"opIcon": "INML2G_opIcon",
			"opMain": "INML2G_opMain",
			"opName": "INML2G_opName",
			"opPanel": "INML2G_opPanel",
			"opPanelTitle": "INML2G_opPanelTitle",
			"opQueuedIcon": "INML2G_opQueuedIcon",
			"opRow": "INML2G_opRow",
			"opRowAlert": "INML2G_opRowAlert",
			"opStatus": "INML2G_opStatus",
			"opStatusBad": "INML2G_opStatusBad",
			"opTop": "INML2G_opTop",
			"opVerb": "INML2G_opVerb",
			"opWrap": "INML2G_opWrap",
			"orderPanel": "INML2G_orderPanel",
			"orphBadge": "INML2G_orphBadge",
			"orphRow": "INML2G_orphRow",
			"ovArrow": "INML2G_ovArrow",
			"ovByTag": "INML2G_ovByTag",
			"ovFrom": "INML2G_ovFrom",
			"ovRow": "INML2G_ovRow",
			"owner": "INML2G_owner",
			"pageEllipsis": "INML2G_pageEllipsis",
			"pageInfo": "INML2G_pageInfo",
			"pager": "INML2G_pager",
			"pagerPages": "INML2G_pagerPages",
			"panelActions": "INML2G_panelActions",
			"panelNote": "INML2G_panelNote",
			"pct": "INML2G_pct",
			"presetList": "INML2G_presetList",
			"presetName": "INML2G_presetName",
			"presetRow": "INML2G_presetRow",
			"progress": "INML2G_progress",
			"reassure": "INML2G_reassure",
			"reassureOk": "INML2G_reassureOk",
			"repoLink": "INML2G_repoLink",
			"repoMark": "INML2G_repoMark",
			"retryBtn": "INML2G_retryBtn",
			"root": "INML2G_root",
			"roster": "INML2G_roster",
			"rosterAuthor": "INML2G_rosterAuthor",
			"rosterMain": "INML2G_rosterMain",
			"rosterName": "INML2G_rosterName",
			"rosterRow": "INML2G_rosterRow",
			"rosterRowOut": "INML2G_rosterRowOut",
			"rosterSplit": "INML2G_rosterSplit",
			"rosterTag": "INML2G_rosterTag",
			"rosterTagDrop": "INML2G_rosterTagDrop",
			"rosterTagKeep": "INML2G_rosterTagKeep",
			"row1": "INML2G_row1",
			"sectAction": "INML2G_sectAction",
			"sectionOverview": "INML2G_sectionOverview",
			"setActions": "INML2G_setActions",
			"setBetaTag": "INML2G_setBetaTag",
			"setBody": "INML2G_setBody",
			"setCard": "INML2G_setCard",
			"setCardOpen": "INML2G_setCardOpen",
			"setCheck": "INML2G_setCheck",
			"setChevron": "INML2G_setChevron",
			"setChevronOpen": "INML2G_setChevronOpen",
			"setConfirm": "INML2G_setConfirm",
			"setDanger": "INML2G_setDanger",
			"setDesc": "INML2G_setDesc",
			"setHeader": "INML2G_setHeader",
			"setHeadText": "INML2G_setHeadText",
			"setHint": "INML2G_setHint",
			"setLabel": "INML2G_setLabel",
			"setLabelBox": "INML2G_setLabelBox",
			"setName": "INML2G_setName",
			"setRow": "INML2G_setRow",
			"setSeg": "INML2G_setSeg",
			"setSegBtn": "INML2G_setSegBtn",
			"setSegOn": "INML2G_setSegOn",
			"shot": "INML2G_shot",
			"shots": "INML2G_shots",
			"snapConfirmText": "INML2G_snapConfirmText",
			"snapList": "INML2G_snapList",
			"snapMeta": "INML2G_snapMeta",
			"snapRow": "INML2G_snapRow",
			"sp": "INML2G_sp",
			"spec": "INML2G_spec",
			"specTag": "INML2G_specTag",
			"specTagFile": "INML2G_specTagFile",
			"specTagGit": "INML2G_specTagGit",
			"spin": "INML2G_spin",
			"src": "INML2G_src",
			"staleAction": "INML2G_staleAction",
			"star": "INML2G_star",
			"stateDot": "INML2G_stateDot",
			"stateTag": "INML2G_stateTag",
			"stickyHead": "INML2G_stickyHead",
			"sub": "INML2G_sub",
			"submitLink": "INML2G_submitLink",
			"subTabs": "INML2G_subTabs",
			"swatches": "INML2G_swatches",
			"switch": "INML2G_switch",
			"switchKnob": "INML2G_switchKnob",
			"switchMixed": "INML2G_switchMixed",
			"switchOn": "INML2G_switchOn",
			"tab": "INML2G_tab",
			"tabs": "INML2G_tabs",
			"tabSearch": "INML2G_tabSearch",
			"tabSearchRow": "INML2G_tabSearchRow",
			"tag": "INML2G_tag",
			"themeActions": "INML2G_themeActions",
			"themeCard": "INML2G_themeCard",
			"themeCardBody": "INML2G_themeCardBody",
			"themeCardFooter": "INML2G_themeCardFooter",
			"themeCardHead": "INML2G_themeCardHead",
			"themeCover": "INML2G_themeCover",
			"themeCoverEmpty": "INML2G_themeCoverEmpty",
			"themeDescription": "INML2G_themeDescription",
			"themeFullscreenBtn": "INML2G_themeFullscreenBtn",
			"themeGallery": "INML2G_themeGallery",
			"themeIdentity": "INML2G_themeIdentity",
			"themeLifecycle": "INML2G_themeLifecycle",
			"themePreviewAction": "INML2G_themePreviewAction",
			"themePreviewCount": "INML2G_themePreviewCount",
			"themeResultBar": "INML2G_themeResultBar",
			"themeSearch": "INML2G_themeSearch",
			"themesGrid": "INML2G_themesGrid",
			"themeStatus": "INML2G_themeStatus",
			"themeStatusMuted": "INML2G_themeStatusMuted",
			"themeToolbar": "INML2G_themeToolbar",
			"themeToolbarActions": "INML2G_themeToolbarActions",
			"title": "INML2G_title",
			"titleRow": "INML2G_titleRow",
			"top": "INML2G_top",
			"topBtn": "INML2G_topBtn",
			"version": "INML2G_version",
			"viewBar": "INML2G_viewBar",
			"viewBtn": "INML2G_viewBtn",
			"viewOn": "INML2G_viewOn",
			"warnLine": "INML2G_warnLine"
		};
		//#endregion
